...
public class MassageApp {
    ...
    public static final String DATA_TYPE_IS_NOT_NUMBER = "You entered not number. Please enter number.";
    ...
    public static final String STRING_IS_NULL = "You didn't enter char";
}
